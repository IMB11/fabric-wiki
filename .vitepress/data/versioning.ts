...
export const LATEST_VERSION = '1.20.4'
...
export function generateVersionRewrites(): Record<string, string> {
  ...
  // Remove .gitkeep from the versions array if it exists.
  const gitkeepIndex = versions.indexOf('.gitkeep')
  if (gitkeepIndex > -1) versions.splice(gitkeepIndex, 1)
